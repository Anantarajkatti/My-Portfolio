  ...
  return (
    ...
    <div className="flex py-10 gap-20 tablet:flex-col ">
      ...
      <div className="flex flex-col gap-5 w-1/2">
        <h1 className="text-secondary text-4xl font-semibold">{projectList[selectedItemIndex].projectName}</h1>
        <h1 className="text-secondary text-2xl">{projectList[selectedItemIndex].link}</h1>
        <h1 className="text-[#98547d] text-xl">{projectList[selectedItemIndex].description}</h1>
