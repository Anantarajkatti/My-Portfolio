      ...
      <div className="flex py-10 gap-20 tablet:flex-col ">
        ...
        <div className="flex flex-col gap-5 w-1/2">
          <h1 className="text-secondary text-4xl font-semibold">
            {projectRes[selectedItemIndex].projectName}
          </h1>

          <Link
            to={projectRes[selectedItemIndex].link}
            className=" text-2xl text-green-500 font-bold"
          >
            🔗{projectRes[selectedItemIndex].link}
          </Link>
          <h1 className="text-[#98547d] text-xl">
            {projectRes[selectedItemIndex].description}
          </h1>
